	...
	//.c fov / project
//	#define SMPTM_M4X4fFOV tanf(90.0F * 0.5F)
	#define SMPTM_M4X4fFOV tanf(90.0F * (M_PI / 180.0F) / 2.0F)
...
//		(m4x4_p)[0] = 1.0F / (SMPTM_M4X4fFOV * SMPTM_M4X4fASPECT); \
//		(m4x4_p)[5] = 1.0F / SMPTM_M4X4fFOV; \
