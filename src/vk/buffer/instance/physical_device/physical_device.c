...
void vk_makePhysicalDevice()
{
	...
	m_vkqueue_graphics_ptr = malloc(sizeof(VkQueue*) * physical_device);
	m_graphics_ptr = malloc(sizeof(uint32_t*) * physical_device);
	m_max_graphics_ptr = malloc(sizeof(uint8_t) * physical_device);
