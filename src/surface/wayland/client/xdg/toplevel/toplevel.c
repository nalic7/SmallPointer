struct xdg_toplevel *smpt_sf_wl_ce_xdg_tl_p;
...
struct xdg_toplevel_listener smpt_sf_wl_ce_xdg_tl_listener =
{
...
{
	SMPT_DBmR2L("xdg_surface_get_toplevel %p", smpt_sf_wl_ce_xdg_tl_p = xdg_surface_get_toplevel(smpt_sf_wl_ce_xdg_sf_p))
	SMPT_DBmR2L("xdg_toplevel_add_listener %d", xdg_toplevel_add_listener(smpt_sf_wl_ce_xdg_tl_p, &smpt_sf_wl_ce_xdg_tl_listener, NULL))
}

void smpt_sf_wl_ce_xdg_tl_free()
{
	xdg_toplevel_destroy(smpt_sf_wl_ce_xdg_tl_p);
}
