struct zwp_relative_pointer_manager_v1 *smpt_sf_wl_ce_zwp_rp_mng_p;
struct zwp_relative_pointer_v1 *smpt_sf_wl_ce_zwp_rp_p = NULL;
...
struct zwp_relative_pointer_v1_listener smpt_sf_wl_ce_zwp_rp_listener =
{
...
{
	if (smpt_sf_wl_ce_zwp_rp_p)
	{
		zwp_relative_pointer_v1_destroy(smpt_sf_wl_ce_zwp_rp_p);
		smpt_sf_wl_ce_zwp_rp_p = NULL;
	}

	zwp_relative_pointer_manager_v1_destroy(smpt_sf_wl_ce_zwp_rp_mng_p);
}
