...
void _sf_wlc_zwp_pc_set()
{
	...
	{
		NALI_D_INFO("zwp_pointer_constraints_v1_lock_pointer %p", _sf_wlc_zwp_lp_p = zwp_pointer_constraints_v1_lock_pointer(_sf_wlc_zwp_pc_p, _sf_wlc_sf_p, _sf_wlcs_pt_p, NULL, ZWP_POINTER_CONSTRAINTS_V1_LIFETIME_PERSISTENT))
		...
		NALI_D_INFO("zwp_relative_pointer_manager_v1_get_relative_pointer %p", _sf_wlc_zwp_rp_p = zwp_relative_pointer_manager_v1_get_relative_pointer(_sf_wlc_zwp_rp_mng_p, _sf_wlcs_pt_p))
