void wlczwp_setPointer()
{
	...
	else
	{
		...
		NALI_D_INFO("zwp_locked_pointer_v1_add_listener %d", zwp_locked_pointer_v1_add_listener(wlc_zwp_locked_pointer_v1_p, &wlczwp_zwp_locked_pointer_v1_listener, NULL))
		...
		NALI_D_INFO("zwp_relative_pointer_v1_add_listener %d", zwp_relative_pointer_v1_add_listener(wlc_zwp_relative_pointer_v1_p, &wlczwp_zwp_relative_pointer_v1_listener, NULL))
	}
}