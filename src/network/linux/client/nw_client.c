...
// 	{
// 		uint16_t length;
// 		if (recv(m_socket, &length, sizeof(uint16_t), 0) <= 0)
// 		{
// 			error("recv")
// 		}
...
// 		if (recv(m_socket, char_p, length, 0) <= 0)
// 		{
// 			error("recv")
// 		}
...
// 	if (inet_pton(AF_INET, "127.0.0.1", &sockaddr_in.sin_addr) <= 0)
// 	{
// 		error("inet_pton")
// 	}
...
// 		if (send(m_socket, message, size, 0) <= 0)
// 		{
// 			error("send")
// 		}
// 	}
