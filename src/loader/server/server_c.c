// NALI_LB_CHT *lsc_u_p;
// NALI_LB_CHT lsc_u_bl = 0;

// NALI_LB_CHT *lsc_m_p;
// NALI_LB_CHT lsc_m_bl = 0;
...
void lsc_sync_all_m_c2new_u(NALI_LB_UT ui)
{
	...
	*(NALI_LB_MIT *)ls_net_p = lsm_bl;
	...
	memcpy(ls_net_p + ls_net_bl, lb_m_p, lsm_bl * sizeof(NALI_LB_MT));
...
void lsc_save()
{
	// for (NALI_LB_CHT l_0 = 0; l_0 < lsc_u_bl; ++l_0)
	// {

	// }

	for (NALI_LB_CHT l_0 = 0; l_0 < lsc_m_bl; ++l_0)
	{
