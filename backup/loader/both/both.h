...
#define NALI_LB_C_ADD_U_C 0
#define NALI_LB_C_SYNC_ALL_U_C2NEW_U 1
#define NALI_LB_C_RM_U_C 2
#define NALI_LB_C_ADD_M_C 3
#define NALI_LB_C_SYNC_ALL_M_C2NEW_U 4
#define NALI_LB_C_RM_M_C 5
//e1-client
